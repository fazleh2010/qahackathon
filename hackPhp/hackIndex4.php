...
<p>The hackathon aims to improve the QA system on the combination of semantic web and language technologies. There are several possibilities to extend the system such as(i) extend the grammar coverage for DBpedia (ii) extend the system for another Linked dataset, (iii) extending the QA system for multiple languages, (iv) improve the question-answering user interface etc. We also will be very glad to know the creative ideas and directions from the participants.We welcome cross-disciplinary collaborations of computer scientists, computational linguistics and related fields to participate and contribute any level of their interest</p>
