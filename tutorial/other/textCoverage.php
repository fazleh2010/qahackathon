...
<link rel='stylesheet' id='twentyseventeen-style-css'  href='http://embeddia.eu/wp-content/themes/twentyseventeen/style.css?ver=20201208' media='all' />
<link rel='stylesheet' id='twentyseventeen-block-style-css'  href='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/css/blocks.css?ver=20190105' media='all' />
<!--[if lt IE 9]>
<link rel='stylesheet' id='twentyseventeen-ie8-css'  href='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/css/ie8.css?ver=20161202' media='all' />
<![endif]-->
<script id='ahc_front_js-js-extra'>
var ahc_ajax_front = {"ajax_url":"http:\/\/embeddia.eu\/wp-admin\/admin-ajax.php","page_id":"864","page_title":"EACL Hackashop on News Media Content Analysis and Automated Report Generation","post_type":"page"};
</script>
<script src='http://embeddia.eu/wp-content/plugins/visitors-traffic-real-time-statistics/js/front.js?ver=5.7.2' id='ahc_front_js-js'></script>
<script src='http://embeddia.eu/wp-includes/js/jquery/jquery.min.js?ver=3.5.1' id='jquery-core-js'></script>
<script src='http://embeddia.eu/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2' id='jquery-migrate-js'></script>
<script id='sdm-scripts-js-extra'>
var sdm_ajax_script = {"ajaxurl":"http:\/\/embeddia.eu\/wp-admin\/admin-ajax.php"};
</script>
<script src='http://embeddia.eu/wp-content/plugins/simple-download-monitor/js/sdm_wp_scripts.js?ver=5.7.2' id='sdm-scripts-js'></script>
<!--[if lt IE 9]>
<script src='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/js/html5.js?ver=20161020' id='html5-js'></script>
<![endif]-->
<link rel="https://api.w.org/" href="http://embeddia.eu/wp-json/" /><link rel="alternate" type="application/json" href="http://embeddia.eu/wp-json/wp/v2/pages/864" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://embeddia.eu/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="http://embeddia.eu/wp-includes/wlwmanifest.xml" /> 
<meta name="generator" content="WordPress 5.7.2" />
<link rel="canonical" href="http://embeddia.eu/hackashop2021/" />
<link rel='shortlink' href='http://embeddia.eu/?p=864' />
<link rel="alternate" type="application/json+oembed" href="http://embeddia.eu/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fembeddia.eu%2Fhackashop2021%2F" />
...
header.site-header {
	background-image: url('/wp-content/uploads/2019/07/net-topleft.png');
...
<ul class="simple">
<li><a class="reference internal" href="#the-world" id="id3">Extend grammar coverage</a><ul>
<li><a class="reference internal" href="#examples" id="id12">Create a lexical entry for NounPPFrame</a><ul><>
<li><a class="reference internal" href="#examples" id="id12">Create a lexical entry for TransitiveFrame</a><ul>
<li><a class="reference internal" href="#examples" id="id12">Create a lexical entry for InTransitivePPFrame</a><ul>
<li><a class="reference internal" href="#examples" id="id12">Create a lexical entry for Attributive Adjective</a><ul>
<li><a class="reference internal" href="#examples" id="id12">Create a lexical entry for Gradable Adjective</a><ul>
</li>
</ul>
...
<li><a class="reference internal" href="#creating-a-volume" id="id9">Extend the system for a dataset</a><ul>
...
<li><a class="reference internal" href="#new-language" id="id10">3.Extend QA system for a language</a><ul>
<li><a class="reference internal" href="#project" id="id101">3.1 Create a branch</a></li>
<li><a class="reference internal" href="#base-file" id="id102">3.2 Write a base file</a></li>
<li><a class="reference internal" href="#sentence-template" id="id103">3.3 Write sentence template</a></li>
...
<h1> <span class="mw-headline" id="Background_on_WebLicht_and_Motivation_for_TCF"> Background on WebLicht and Motivation for TCF </span></h1>
<p>WebLicht is a service orchestration and execution environment for incremental automatic annotation of text corpora, built upon Service Oriented Architecture principles. Language processing tools (tokenizers, taggers, parsers, etc), provided as webservices, have been integrated into WebLicht.
</p><p>A WebLicht webservice is simply a synchronous REST‐style web service. The service processes the input data synchronously and returns the result as output data, using the same HTTP connection. Each tool, implemented as a webservice, is hosted locally at the institution where it was developed.
</p><p>Normally, a tool requires one or more annotation layers to be present in the input document, and those layers are used to generate further annotations. The WebLicht web application helps users to combine the available tools into valid processing chains. Running a processing chain means that tools are invoked one after the other, where the output of each tool is used as input for the next tool in the chain. Tool execution is performed in a distributed fashion by calls to the servers that host the tools in question.
</p><p>Many of the tools that have been integrated into WebLicht are well known within the linguistic community and have been in use for many years. They were mainly developed as command‐line tools and each uses its own format for storing results. For this reason, it was not possible to combine such tools into processing chains easily. In order for the tools to “talk to each other”, it was necessary to create a highly efficient internal format for sharing data between services.
</p><p>A common XML data exchange format (Text Corpus Format, TCF) has been developed within the WebLicht architecture to facilitate efficient interoperability between the tools The TCF format allows the various linguistic annotations produced by the tools within WebLicht to be stored in one document. It supports incremental enrichment of linguistic annotations at various levels of analysis in a stand-­off XML‐based format. Each tool may add one or more annotation layers to the data document, but tools are not permitted to remove or alter any existing layers within the document. This means that the document grows with each annotation:
</p><p><br />
<a href="/weblichtwiki/index.php/File:TCF-Add-Layers.png" class="image"><img alt="TCF-Add-Layers.png" src="/weblichtwiki/images/thumb/4/48/TCF-Add-Layers.png/500px-TCF-Add-Layers.png" width="500" height="92" /></a>
</p><p><br />
...
<h2> <span class="mw-headline" id="Annotation_Layers"> Annotation Layers </span></h2>
<p>The next example shows a TCF document containing all possible annotation layers with an explanation of each layer. 
</p>
<h3> <span class="mw-headline" id="Text"> Text </span></h3>
<p>The <i>text</i> layer contains a character string representing natural language text. This layer is commonly used by linguistic tools to produce token and sentence boundary annotations. 
</p>
<pre>
    &lt;text&gt;Karin fliegt nach New York. Sie will dort Urlaub machen.&lt;/text&gt;
</pre>
<h3> <span class="mw-headline" id="Tokens"> Tokens </span></h3>
<p>The <i>tokens</i> layer is composed of token elements, each having a unique identifier (ID) and token string value, as presented below. Optionally, each token can reference its start and end character offset position in relation to the character string in the text layer. The tokens layer is the main anchor layer among TextCorpus layers, i.e. all other layers (with the exception of the text layer) directly or indirectly (via other layers) reference tokens by referencing token identifiers.
</p>
<pre>
    &lt;tokens&gt;
      &lt;token ID=&quot;t_0&quot;&gt;Karin&lt;/token&gt;
...
<h3> <span class="mw-headline" id="Sentences"> Sentences </span></h3>
<p>The <i>sentences</i> layer represents sentence boundary annotations. Each sentence element enumerates token identifiers of tokens that belong to this sentence, as shown below.
Optionally, a sentence can have start and end character offset positions in relation to the character string in the text layer.
</p>
<pre>
    &lt;sentences&gt;
      &lt;sentence ID=&quot;s_0&quot; tokenIDs=&quot;t_0 t_1 t_2 t_3 t_4 t_5&quot;/&gt;
      &lt;sentence ID=&quot;s_1&quot; tokenIDs=&quot;t_6 t_7 t_8 t_9 t_10 t_11&quot;/&gt;
    &lt;/sentences&gt;
</pre>
<h3> <span class="mw-headline" id="Lemmas"> Lemmas </span></h3>
<p>The <i>lemmas</i> layer represents lemma annotations on tokens. Each lemma element references a token, or sequence of tokens, via token identifiers, and provides the lemma string value, as shown here:
</p>
<pre>
    &lt;lemmas&gt;
      &lt;lemma ID=&quot;le_0&quot; tokenIDs=&quot;t_0&quot;&gt;Karin&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_1&quot; tokenIDs=&quot;t_1&quot;&gt;fliegen&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_2&quot; tokenIDs=&quot;t_2&quot;&gt;nach&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_3&quot; tokenIDs=&quot;t_3&quot;&gt;--&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_4&quot; tokenIDs=&quot;t_4&quot;&gt;York&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_5&quot; tokenIDs=&quot;t_5&quot;&gt;--&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_6&quot; tokenIDs=&quot;t_6&quot;&gt;sie&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_7&quot; tokenIDs=&quot;t_7&quot;&gt;wollen&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_8&quot; tokenIDs=&quot;t_8&quot;&gt;dort&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_9&quot; tokenIDs=&quot;t_9&quot;&gt;Urlaub&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_10&quot; tokenIDs=&quot;t_10&quot;&gt;machen&lt;/lemma&gt;
      &lt;lemma ID=&quot;le_11&quot; tokenIDs=&quot;t_11&quot;&gt;--&lt;/lemma&gt;
    &lt;/lemmas&gt;
</pre>
...
<h3><a class="toc-backref" href="#id10">3. Extend QA system for a new language</a><a class="headerlink" href="#new-language" title="Permalink to this headline"></a></h3>
...
<h3><a class="toc-backref" href="#id101">3.1 Create a branch/Fork the project</a><a class="headerlink" href="#project" title="Permalink to this headline"></a></h3>
To extend the system create a branch of the <a href="https://github.com/fazleh2010/question-grammar-generator.git">QueGG project</a>. Alternatively, fork the project.  
</div>

<div class="section" id="base-file">
<h3><a class="toc-backref" href="#id102">3.2 Write a base file</a><a class="headerlink" href="#base-file" title="Permalink to this headline"></a></h3>
<p>The base file contains syntactic information and  written of articles, propositions, pronouns etc.  The base file for english can be seen <a href="https://github.com/fazleh2010/question-grammar-generator/blob/master/src/main/resources/en/base/base.ttl">here</a>. To create base file click <a href="http://localhost/tutorial/form/BaseFileForm.php">here</a>.</p><div>
</div>
...
<!--label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1622187435" /><input type="hidden" name="_mc4wp_form_id" value="572" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form></section><section id="custom_html-4" class="widget_text widget widget_custom_html"><div class="textwidget custom-html-widget">(for previous issues see <a href="https://us4.campaign-archive.com/home/?u=9bfa5828861090a04fd6079a4&id=8382bea2a8">archive</a>)</div></section><section id="wpt-latest-tweets-2" class="widget wpt-latest-tweets"><h2 class="widget-title">Recent Tweets</h2><div class="wpt-header"><div class='wpt-follow-button'><a href='https://twitter.com/embeddiaproject' class='twitter-follow-button wpt-right' data-width='30px' data-show-screen-name='false' data-size='large' data-show-count='false' data-lang='en'>Follow @embeddiaproject</a></div>		<p>			<img src='https://pbs.twimg.com/profile_images/1082588561793261568/j-jHcCiA_normal.jpg' alt='' class='wpt-twitter-avatar wpt-left ' />
			<span class='wpt-twitter-name'>embeddia</span><br />
			<span class='wpt-twitter-id'><a href='https://twitter.com/embeddiaproject'>@embeddiaproject</a></span>
		</p></div><ul>
<li class="favorited  lang-en">Our dissemination manager Marko Milosavljević has published a chapter on the influence of #automation on core value… <a href="https://t.co/aMNWg5g6dV" rel="nofollow">twitter.com/i/web/status/1…</a><br /><span class='wpt-tweet-time'><a href="http://twitter.com/1064940934528421888/status/1397810329791483906">about 1 day ago</a></span>  </li>
<li class="favorited  lang-en">‼️ EMBEDDIA article ‼️
Access our #paper on Slav-#NER involved with recognizing mentions of named entities in #web… <a href="https://t.co/29PTpuCQU7" rel="nofollow">twitter.com/i/web/status/1…</a><br /><span class='wpt-tweet-time'><a href="http://twitter.com/1064940934528421888/status/1397450347799629826">about 2 days ago</a></span>  </li>
<li class="favorited  lang-en">@idgconnect about the Global #AI Action Alliance launched by the @wef in 2021 with the goal of accelerating the "ad… <a href="https://t.co/Z7tagIvklF" rel="nofollow">twitter.com/i/web/status/1…</a><br /><span class='wpt-tweet-time'><a href="http://twitter.com/idgconnect/status/1397093818160271360">about 3 days ago</a></span>  </li>
<li class="favorited  lang-en">In between #ethical principles of human-centred #AI and practice. @benbendc from @UofMaryland believes "putting peo… <a href="https://t.co/nHftmsma5D" rel="nofollow">twitter.com/i/web/status/1…</a><br /><span class='wpt-tweet-time'><a href="http://twitter.com/1064940934528421888/status/1396736058226843650">about 4 days ago</a></span>  </li>
<li class="favorited  lang-en">This week @EFJEUROPE called on public authorities "not to regulate the use of artificial intelligence in newsrooms,… <a href="https://t.co/pMXS8IaLYt" rel="nofollow">twitter.com/i/web/status/1…</a><br /><span class='wpt-tweet-time'><a href="http://twitter.com/1064940934528421888/status/1395765760669200390">about 7 days ago</a></span>  </li>
<li class="favorited  lang-en">"The launch follows three years of development at the #company, which has long viewed #healthcare as a market ripe… <a href="https://t.co/5YlLwB7QM2" rel="nofollow">twitter.com/i/web/status/1…</a><br /><span class='wpt-tweet-time'><a href="http://twitter.com/1064940934528421888/status/1395281091439775745">about 1 week ago</a></span>  </li>
</ul>
</section>
<section id="fbw_id-2" class="widget widget_fbw_id"><h2 class="widget-title">Facebook Page</h2><div class="fb_loader" style="text-align: center !important;"><img src="http://embeddia.eu/wp-content/plugins/facebook-pagelike-widget/loader.gif" alt="Facebook Pagelike Widget" /></div><div id="fb-root"></div>
        <div class="fb-page" data-href="https://www.facebook.com/embeddia " data-width="300" data-height="500" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="true" data-show-posts="false" style="" hide_cta="false" data-tabs=""></div></section>    
    <section id="custom_html-2" class="widget_text widget widget_custom_html"><h2 class="widget-title">Horizon 2020</h2><div class="textwidget custom-html-widget"><figure><img float="left" width="150" src="http://embeddia.eu/wp-content/uploads/2019/05/EU_flag_yellow_low-300x201.jpg" class="image" alt="European Union Horizon 2020 funding credit" style="max-width: 100%; height: auto; float: left; padding: 0px 5px;" title="Horizon 2020" /><figcaption class="wp-caption-text" style="font-style: italic; font-size: 85%;">This project has received funding from European Union's Horizon 2020 research and innovation programme under grant agreement No 825153</figcaption></figure></div></section></aside><</div>
...
<script>			var sc_project=12007826;
...
<script src='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/js/skip-link-focus-fix.js?ver=20161114' id='twentyseventeen-skip-link-focus-fix-js'></script>
<script src='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/js/navigation.js?ver=20161203' id='twentyseventeen-navigation-js'></script>
<script src='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/js/global.js?ver=20190121' id='twentyseventeen-global-js'></script>
<script src='http://embeddia.eu/wp-content/themes/twentyseventeen/assets/js/jquery.scrollTo.js?ver=2.1.2' id='jquery-scrollto-js'></script>
<script src='http://embeddia.eu/wp-includes/js/wp-embed.min.js?ver=5.7.2' id='wp-embed-js'></script>
<script src='https://platform.twitter.com/widgets.js?ver=5.7.2' id='twitter-platform-js'></script>
<script id='milapfbwidgetscript-js-extra'>
var milapfbwidgetvars = {"app_id":"503595753002055","select_lng":""};
</script>
<script src='http://embeddia.eu/wp-content/plugins/facebook-pagelike-widget/fb.js?ver=1.0' id='milapfbwidgetscript-js'></script>
<script defer src='http://embeddia.eu/wp-content/plugins/mailchimp-for-wp/assets/js/forms.js?ver=4.8.4' id='mc4wp-forms-api-js'></script>
