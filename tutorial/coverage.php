...
<p>NounPPFrame as syntactic behaviour that corresponds to a copulative construction such as <em>X is the capital of Y </em> with two arguments X and Y, where <em>copulativeArg</em> corresponds to the copula subject <em>X</em> and the <em>prepositionalAdjunct</em> corresponds to the prepositional object <em>Y</em>.
The semantics of the relational noun is captured with respect to the property <em>http://dbpedia.org/ontology/capital</em>, where the subject of the property is realized by the <em>prepositionalAdjunct</em> and the object of the property is realized by the copulativeArg. An example is shown below: 
